...
Script Purpose:
    ...
    Load) process to populate the CRM tables in the 
...
create or replace procedure load_crm_silver()
begin
    ...
    select '>>>Inserting into datawarehouse_silver.crm_cust_info' as '';
    ...
    set start_time = now();
    select '>>>Loading crm_prd_info' as '';
    select '>>>Truncating datawarehouse_silver.crm_prd_info' as '';
    truncate table datawarehouse_silver.crm_prd_info;
    select '>>>Inserting into datawarehouse_silver.crm_prd_info' as '';
    ...
    set start_time = now();
    select '>>>Loading crm_sales_details' as '';
    select '>>>Truncating datawarehouse_silver.crm_sales_details' as '';
    truncate table datawarehouse_silver.crm_sales_details;
    select '>>>Inserting into datawarehouse_silver.crm_sales_details' as '';
